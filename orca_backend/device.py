...
def wrapper_getDeviceDetails(device_ip: str):
    ...
    '''
    Sample output :
        {'img_name': 'SONiC-OS-4.0.5-Enterprise_Base', 'mgt_intf': None, 'mgt_ip': '10.10.130.11/23',
    ...
    op_dict['mgt_intf'] = op2.get('sonic-mgmt-interface:sonic-mgmt-interface').get(
        'MGMT_INTF_TABLE').get('MGMT_INTF_TABLE_IPADDR_LIST')[0].get('eth0')
